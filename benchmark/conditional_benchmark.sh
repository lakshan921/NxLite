...
ab -n 100000 -c 1000 -H "If-None-Match: $ETAG" http://localhost:7888/index.html
   
   # Compare with regular requests
echo "Running benchmark with regular requests..."
ab -n 100000 -c 1000 http://localhost:7888/index.html
